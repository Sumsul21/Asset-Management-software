        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="{{ route('dep_det.index') }}" class="btn btn-sm btn-primary"><i class="fa fa-reply"></i><span class="btn-icon-add"></span>Back</a>
                </div>
                ...
                <div class="card-body">
                    <div class="form-validation">
                        ...
                        @endif
                        <!-- this is from -->
                        <form class="form-valide" action="{{route('dep_det.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-xl-6">
