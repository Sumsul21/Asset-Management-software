                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-sm-12">
                                    <div class="row">
                                        ...
                                        <label class="col-6 col-form-label" id="sup_name"></label>
                                    </div>
                                </div>
    ...
    $('#table-body').empty();
        $.ajax({
            ...
            success: function(response) {
                ...
                $("#sup_name").html(dataMast.sup_name);
                ...
                $.each(dataDetails, function(index, item) {
                    ...
                    row += '<td>' + item.group_name + '</td>'; // Add Category column
                    row += '<td>' + item.type_name + '</td>'; // Add Group Name column
