            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-validation">
                        ...
                        <!-- this is from -->
                        <form class="form-valide" action="{{ route('dept_loc.store') }}" method="post"
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" id="location_name" class="form-control @error('location_name') is-invalid @enderror" name="location_name" value="{{old('location_name')}}">
                                                @error('location_name')
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" id="contact_perName" class="form-control @error('contact_perName') is-invalid @enderror" name="contact_perName" value="{{old('contact_perName')}}">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="number" id="contact_phNumber" class="form-control @error('contact_phNumber') is-invalid @enderror" name="contact_phNumber" value="{{old('contact_phNumber')}}">
