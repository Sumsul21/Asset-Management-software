        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="{{ route('supply_name.index') }}" class="btn btn-sm btn-primary"><i class="fa fa-reply"></i><span class="btn-icon-add"></span>Back</a>
                </div>
                ...
                <div class="card-body">
                    <div class="form-validation">
                        ...
                        <!-- this is from -->
                        <form class="form-valide" action="{{ route('supply_name.store') }}" method="post"
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <div class="row-lg">
                                            <input type="text" id="supplier_name"
                                                ...
                                                name="sup_name" value="{{ old('sup_name') }}" pattern="[a-zA-Z]+.*"
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <div class="row-lg">
                                            <input type="text" id="contact_perName"
                                                ...
                                                name="contact_perName" value="{{ old('contact_perName') }}" pattern="[a-zA-Z]+.*"
                                                title="Leave name must start with alphabets then others" autofocus
                                                required>
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <div class="row-lg">
                                            <input type="text" id="supplier_address"
                                                ...
                                                name="supplier_address" placeholder="" value="{{ old('supplier_address') }}">
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <div class="row-lg">
                                            <input type="number" id="contact_phNumber"
                                                ...
                                                name="contact_phNumber" placeholder="" value="{{ old('contact_phNumber') }}">
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <div class="row-lg">
                                            <input type="number" id="supplier_phNumber"
                                                ...
                                                name="supplier_phNumber" placeholder="" value="{{ old('supplier_phNumber') }}">
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <div class="row-lg">
                                            <input type="text" id="web_address"
                                                ...
                                                name="web_address" value="{{ old('web_address') }}">
                                            @error('web_address')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <div class="row-lg">
                                            <input type="text" id="designation"
                                                ...
                                                name="designation" placeholder="" value="{{ old('designation') }}">
                                            @error('designation')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <div class="row-lg">
                                            <input type="number" id="fax"
                                                ...
                                                name="fax" placeholder="" value="{{ old('fax') }}">
                                            @error('fax')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <div class="row-lg">
                                            <input type="number" id="credit_limit"
                                                ...
                                                name="credit_limit" placeholder="" value="{{ old('credit_limit') }}">
                                            @error('credit_limit')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
