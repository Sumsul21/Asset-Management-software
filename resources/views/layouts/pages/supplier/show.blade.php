                                    ...
                                    <div class="form-group col">
                                        ...
                                        <div class="row-lg">
                                            <input type="text" id="supplier_address"
                                                ...
                                                name="supplier_address" placeholder="" value="{{ ($data->supplier_address) }}" disabled>
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <div class="row-lg">
                                            <input type="number" id="contact_phNumber"
                                                ...
                                                name="contact_phNumber" placeholder="" value="{{  ($data->contact_phNumber) }}" disabled>
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <div class="row-lg">
                                            <input type="number" id="supplier_phNumber"
                                                ...
                                                name="supplier_phNumber" placeholder="" value="{{( $data->supplier_phNumber) }}" disabled>
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <div class="row-lg">
                                            <input type="text" id="web_address"
                                                ...
                                                name="web_address" value="{{ ($data->web_address) }}" disabled>
                                            @error('web_address')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <div class="row-lg">
                                            <input type="text" id="designation"
                                                ...
                                                name="designation" placeholder="" value="{{ ( $data->designation ) }}" disabled>
                                            @error('designation')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <div class="row-lg">
                                            <input type="number" id="fax"
                                                ...
                                                name="fax" placeholder="" value="{{  ($data->fax) }}" disabled>
                                            @error('fax')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <div class="row-lg">
                                            <input type="number" id="credit_limit"
                                                ...
                                                name="credit_limit" placeholder="" value="{{ ($data->credit_limit) }}" disabled>
                                            @error('credit_limit')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
